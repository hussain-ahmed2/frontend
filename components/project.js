...
function Project({ thumbnail, title, description, repo, live }) {
  return (
    <div className="group flex flex-col bg-neutral-400 rounded-xl overflow-hidden hover:shadow-lg  transition-all duration-200 border-r-4 border-neutral-500 border-b-4 hover:border-neutral-700">
      <div>
        <Image className="group-hover:scale-105 transition-all duration-200" src={thumbnail} alt={`${title}-image`} width={1000} height={500} />
      </div>
